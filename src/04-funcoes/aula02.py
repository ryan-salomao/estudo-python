""" Aula 02 - Arguments: psitional, keyword, defualt value """

# declara um funcao que soma dois numeros
def somar(n1, n2):
    return n1 + n2
...
print(dividir(divisor=3, dividendo=10.0))
...
print('somar numeros de uma dict', somar(**numeros))

...
print('True and True', True and True, type(True and False))
print('True and True', True and True, type(False and True))
print('True and True', True and True, type(False and False))

print('True or True', True or True, type(True or True))
print('True or True', True or True, type(True or False))
print('True or True', True or True, type(False or True))
print('True or True', True or True, type(False or False))
